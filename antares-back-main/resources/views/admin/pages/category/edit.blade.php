...
@section('content')
<form action="{{dashboard_route('dashboard.categories.update', ['category' => $item->id])}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="col">
        <div class="card">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select custom-select" id="parent_id" name="parent_id">
                                    ...
                                    @foreach ($categories as $cat)
                                        <option value="{{$cat->id}}" @if(old('parent_id', $item->parent_id)== $cat->id) selected @endif>
                                            {{$cat->title}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="row row-cols-3">
                                <div class="col">
                                    ...
                                    <div class="custom-switch">
                                        <input type="checkbox" name="is_visible" id="is_visible" value="on" @if(old('is_visible',$item->is_visible)) checked @endif>

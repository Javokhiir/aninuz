...
@section('content')
<form action="{{dashboard_route('dashboard.events.store')}}" class="dropForm" method="post" enctype="multipart/form-data">
    @csrf
    <div class="col">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="card card-form">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="address" name="address" placeholder="@lang("admin.address")"  value="{{old('address')}}">
                    ...
                    <div class="card card-form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="datepicker" name="date" placeholder="@lang("admin.date")" value="{{old('date')}}">

...
@section('content')
<form action="{{dashboard_route('dashboard.brands.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="col">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="card card-form">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="color" name="color" placeholder="@lang("admin.color")" value="{{old('color')}}" data-jscolor="">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="svg" name="svg" placeholder="@lang("admin.svg")" value="{{old('svg')}}">
